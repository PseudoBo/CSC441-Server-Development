const dateRegex = /(((January)|(February)|(March)|(April)|(May)|(June)|(July)|(August)|(September)|(October)|(November)|(December))\W([0-9,]+\W)([0-9]+)?)|(\d(\d?)\/\d(\d)?\/\d\d)|((\d\d)\W([A-Za-z,]){4}\s([0-9]){4})|(\d{4}\-\d{1,2}\-\d{1,2})/gm;
const str = `If you're feeling up to it, call me at 6012664949
